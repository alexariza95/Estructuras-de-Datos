...
#define COTA_ERROR 1.0e-6  //!< Cota de error para la comparación con números reales
...
class Monomio
{
	...
	/*!
			\brief Funcion que devuelve el coeficiente de un Monomio
			\note Funcion inline
	...
	/*!
			\brief Funcion que devuelve el grado de un Monomio
			\note Funcion inline
	...
	*/
	...
	/*!
		...
		\warning Se deben introducir numeros
		\pre     Ninguna
