...
*/
template <class G> class ArbolBinarioOrdenado {
public:
  /*!\name Operaciones.
  @{
  */
  ...
  \return true if el elemento se inserto o false si el elemento ya existía en el
  árbol
  */
  ...
  */
  ...
  \return true if el elemento existe y se borra o false si el elemento no existe
  y no se borra.
  ...
  */
  ...
  Realiza un recorrido pre-orden del árbol, a partir de la raiz , aplicando un
  tratamiento definido por OperadorNodo.
  ...
  */
  ...
  Realiza un recorrido post-orden del árbol, a partir de la raiz, aplicando un
  tratamiento definido por OperadorNodo.
  ...
  */
  ...
  Realiza un recorrido en-orden del árbol, a partir de la raiz, aplicando un
  tratamiento definido por OperadorNodo.
